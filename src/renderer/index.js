...
async function initialize() {
  ...
  // Load WebDNN model
  // WebDNNモデルをロードします
  webdnn_runner = await WebDNN.load('./graph_descriptor');
...
window.addEventListener('load', () => {
  ...
  dev.innerHTML = '<h1>WebDNN exercise</h1><div style="float: left;">Draw digit by mouse below:<br><canvas id="draw" width="256" height="256"></canvas><br><button type="button" id="reset">Reset</button></div><div id="result">(Classification result will be displayed here)</div>'
